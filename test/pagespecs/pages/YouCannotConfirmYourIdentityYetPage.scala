...
class YouCannotConfirmYourIdentityYetPage(baseUrl: String)(implicit webDriver: WebDriver) extends Page(
  baseUrl,
  path = "/get-an-income-tax-refund/you-cannot-confirm-your-identity-yet"
) {
  ...
  override def assertPageIsDisplayed(extraExpectations: ContentExpectation*): Unit = withPageClue {
    ...
    val contentExpectations: Seq[ContentExpectation] = Seq(ContentExpectation(
      ...
      expectedLines =
        """
          |You cannot confirm your identity yet
